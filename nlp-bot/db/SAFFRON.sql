CREATE DATABASE  IF NOT EXISTS `SAFFRON` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `SAFFRON`;
...
INSERT INTO `food_items` VALUES (1,'KESAR(SAFFRON)',600.00),(2,'ALMONDS',990.00),(3,'ALMOND PREMIUM',1280.00),(4,'WALNUT',1300.00),(5,'OPEN WALNUT',1600.00),(6,'KHUMANI',1500.00),(7,'DATES',1400.00),(8,'ANJEER',1400.00),(9,'KHLADI',590.00);
